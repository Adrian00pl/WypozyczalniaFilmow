    ...
    public class FilmyContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Kategoria>().HasData(
                new Kategoria { Id = 1, Nazwa = "Horror", Opis = "Starszny" },
                new Kategoria { Id = 2, Nazwa = "Dokumentalne", Opis = "Dokumentalny" },
                new Kategoria { Id = 3, Nazwa = "Thriller", Opis = "Dreszczowce" },
                new Kategoria { Id = 4, Nazwa = "Sensacyjne", Opis = "Filmy z akcją" },
                new Kategoria { Id = 5, Nazwa = "Fantasy", Opis = "Magiczne" });
        ...
        internal static object Find(int idFilmu)
        {
